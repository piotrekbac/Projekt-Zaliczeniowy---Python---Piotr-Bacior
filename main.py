from src.calculator import calculate_bmi, calculate_ideal_weight, calculate_bmr, calculate_tdee, calculate_macros           # Importujemy funkcję calculate_bmi z modułu calculator
...
from src.prediction import predict_goal_date                                                                                # Importujemy funkcję predict_goal_date z modułu prediction
    ...
    while True:    
        ...
        try:
            ...
            if kategoria == "Niedowaga":
                ...
                # Obliczamy docelowe zapotrzebowanie kaloryczne dla osób z niedowagą, które mają na celu przybrać na wadze w zdrowy sposób, dodając 500 kcal do obliczonego TDEE
            ...
            # Ustawiamy cel dietetyczny dla osób z normą, który ma na celu pomóc im utrzymać zdrową wagę
                ...
                if kategoria == "Otyłość":
                    ...
                    # Obliczamy docelowe zapotrzebowanie kaloryczne dla osób z otyłością, które mają na celu schudnąć w zdrowy sposób, odejmując 650 kcal od obliczonego TDEE, aby zapewnić bardziej agresywną redukcję kalorii, która może być potrzebna w przypadku otyłości
            ...
            print(f"{'TWOJA DIETA I METABOLIZM':^70}")                          # Wyświetlamy nagłówek dla sekcji diety i metabolizmu, umieszczając go na środku, aby był bardziej estetyczny i czytelny dla użytkownika w konsoli
            print("-" * 70)                                                     # Dodajemy linię oddzielającą nagłówek od wyników, aby poprawić czytelność w konsoli
