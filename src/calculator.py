...
def calculate_macros(target_kcal: float, goal: str) -> tuple[int, int, int] :
    ...
    if target_kcal <= 0:
        ...
        # Informujemy użytkownika, że docelowe kalorie muszą być większe niż 0
    ...
    # Obliczamy ilość tłuszczów w gramach, dzieląc kalorie przeznaczone na tłuszcze przez 9 (kcal/g)
    fats_g = (target_kcal * f_pct) / 9
